           ...
           <!-- Os expression language usados abaixo no formulário funcionam na lógica do método get() -->
                    <form action="gerenciarProduto" method="POST" 
                        ...
                        <div class="form-group row offset-md-2 mt-3">
                            ...
                            <div class="form-group row offset-md-2 mt-3">
                            <label for="idnome" class="col-sm-2 form-label">Descricao</label>
                            <div class="col-md-5">
                                <!-- Propriedade idnome pode ser usado como referência
                                para a utiização de alguma implementação de JavaScript 
                                sm , md, lg = tamanhos e mt = margin top -->
                        ...
                        <div class="form-group row offset-md-2 mt-3">
                            ...
                            <div class="col-md-2">
                                <input type="date" name="dataCadastro" id="iddata" 
                                       class="form-control" value="${produto.dataCadastro}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row offset-md-2 mt-3">
                            ...
                            <div class="col-md-1">
                                <select id="idstatus" name="status"
                                    ...
                                    <option value="1"
                                    <c:if test="${produto.status == 1}"> selected</c:if>>Ativado</option>

                                    <option value="0"
                                    <c:if test="${roduto.status == 0}"> selected</c:if>>Desativado</option>
